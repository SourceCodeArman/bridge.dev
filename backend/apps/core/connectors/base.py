...
class BaseConnector(ABC):
    ...
    def execute(self, action_id: str, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            hook_registry.execute_after_execute(
                self, action_id, inputs, outputs, context
            )
...
class ConnectorRegistry:
    ...
    def register(self, connector_class: type) -> None:
        ...
        try:
            ...
            raise ValueError(
                f"Failed to get connector ID from {connector_class}: {str(e)}"
            )
            ...
            try:
                ...
                try:
                    ...
                    return type(
                        ...
                        (DatabaseCustomConnector,),
                        {
                            "connector_id": property(lambda self: str(connector.id)),
