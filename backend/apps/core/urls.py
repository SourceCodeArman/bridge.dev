...
router.register(r'alert-configurations', AlertConfigurationViewSet, basename='alertconfiguration')
router.register(r'alert-history', AlertHistoryViewSet, basename='alerthistory')
router.register(r'error-suggestions', ErrorSuggestionViewSet, basename='errorsuggestion')
...
router.register(r'custom-connectors', CustomConnectorViewSet, basename='customconnector')
router.register(r'custom-connector-versions', CustomConnectorVersionViewSet, basename='customconnectorversion')
