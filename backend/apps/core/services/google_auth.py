...
class GoogleAuthService:
    ...
    @staticmethod
    def get_flow(client_id: str, client_secret: str, scopes: List[str], redirect_uri: str) -> google_auth_oauthlib.flow.Flow:
        """
    ...
    def exchange_code_for_token(
        ...
        if scopes is None:
            # Default scopes if not provided (though usually defined by the flow init)
